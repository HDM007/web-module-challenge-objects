...
*/
console.log('snax', 7, 'theater markup')
console.log('cocoa', 12, 'household')
console.log('pancake', 2, 'breakfast')
...
*/
reviews.push({name: 'harry', rating: 4.5, feedback: "This place is a place for sure, yes.",});
